...
if __name__=="__main__":
    ...
    formulae += [Implies(predicates[get_name(c)](x), predicates[get_name(d)](x)) for _, c,d in (ax for ax in onto.get_axioms() if ax[0] == "AxiomKind::SubClassOf" and isinstance(ax[-1], str))]
